...
@JMSDestinationDefinitions(
    value = {
        @JMSDestinationDefinition(
            ...
            destinationName = "SampleQueue"
        ),
        @JMSDestinationDefinition(
            name = "java:/topic/SampleTopic",
            interfaceName = "javax.jms.Topic",
            destinationName = "SampleTopic"
        )
    }
)
...
public class HelloWorldMDBServletClient extends HttpServlet {
    ...
    @Resource(lookup = "java:global/remoteContext/SampleQueue")
    private Queue queue;

    @Resource(lookup = "java:global/remoteContext/SampleTopic")
    private Topic topic;
